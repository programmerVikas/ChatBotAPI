...
public class UserBookingDetailServiceImpl implements UserBookingDetailService {
	...
	@Override
	public UserBookingDetail findByOnlineBookingId(Long onlineId) {
		// TODO Auto-generated method stub
		UserBookingDetail onlineBookingId = userBookingDetailRepository.findByOnlineBookingId(onlineId);
		return onlineBookingId;
	}

	@Override
	@Transactional
	public void deleteAllUserBookingDetail(Long onlineBId) {
		// TODO Auto-generated method stub
		userBookingDetailRepository.deleteAllByOnlineBookingId(onlineBId);
		log.info("User Booking Detail info deleted...");
	}
