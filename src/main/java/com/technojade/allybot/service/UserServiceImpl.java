...
public class UserServiceImpl implements UserService {
	...
	public User saveOrUpdate(User user) {
		...
		if (null != imExist && null == user.getUserId()) {
			user.setUserId(imExist.getUserId());
			registerOrUpdateProfile(user);
			return null;
		}
	...
	@Override
	public User findByMobileNumberOrEmailId(String email, String mobile) {
		// TODO Auto-generated method stub
		return userRepository.findByMobileNumberOrEmailIdAndIsActive("", email, true);
	}
