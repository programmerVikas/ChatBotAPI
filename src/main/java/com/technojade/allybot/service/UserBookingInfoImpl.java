...
public class UserBookingInfoImpl implements UserBookingInfoService {
	...
	public List<UserBookingInfo> findBookingByOnlineId(Long oId) {
		// TODO Auto-generated method stub
		List<UserBookingInfo> userBookingInfo = userBookingInfoRepository.findAllByOnlineBookingId(oId);
		return userBookingInfo;
	}
	...
	@Override
	public UserBookingInfo findUserBookingByOnlineId(Long oId) {
		// TODO Auto-generated method stub
		UserBookingInfo byOnlineBookingId = userBookingInfoRepository.findByOnlineBookingId(oId);
		return byOnlineBookingId;
	}
